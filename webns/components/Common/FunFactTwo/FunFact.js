                ...
                <div className={styles.funfactInnerBox}>
                    ...
                    <div className="col-lg-3 col-sm-6 col-6">
                                <div className={styles.singleFunfactCard}>
                                    ...
                                    <h3>
                                        {FunFactContentData.years_of_experience} <span className={styles.signIcon}>+</span>
                                    </h3>
                            ...
                            <div className="col-lg-3 col-sm-6 col-6">
                                <div className={styles.singleFunfactCard}>
                                    ...
                                    <h3>
                                        {FunFactContentData.delivered_products} <span className={styles.signIcon}>+</span>
                                    </h3>
                                    <p>Total Students</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-sm-6 col-6">
                                <div className={styles.singleFunfactCard}>
                                    ...
                                    <h3>
                                        {FunFactContentData.number_of_clients}<span className={styles.signIcon}>+</span>
                                    </h3>
                                    <p>Alumni</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-sm-6 col-6">
                                <div className={styles.singleFunfactCard}>
                                    ...
                                    <h3>
                                        {FunFactContentData.winning_awards} <span className={styles.signIcon}>+</span>
                                    </h3>
                                    <p>Winning Awards</p>
                                </div>
                            </div>
